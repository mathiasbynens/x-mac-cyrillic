...
// src/x-mac-cyrillic.d.ts → x-mac-cyrillic.d.ts
const TYPES_TEMPLATE = fs.readFileSync('./src/x-mac-cyrillic.d.ts', 'utf8');
const createTypes = template(TYPES_TEMPLATE, TEMPLATE_OPTIONS);
const typesCode = createTypes(require('./export-data.js'));
fs.writeFileSync('./x-mac-cyrillic.d.ts', typesCode);
